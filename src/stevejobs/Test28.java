...
public class Test28
{
	public static void main(String[] args) throws Exception
	{
		...
		List<WebElement> rl=driver.findElements(By.xpath(
		                     "(//*[@role='tabpanel'])[1]/descendant::table/tbody/tr"));
		System.out.println(rl.size()); 
		List<WebElement> cl=rl.get(1).findElements(
				                  By.tagName("td"));
		System.out.println(cl.size());
		List<WebElement> el=cl.get(1).findElements(
				                  By.tagName("div"));
		el.get(0).click();
		//Select checkbox in 2nd col in 3rd row via direct xpath
		driver.findElement(By.xpath(
			"(//*[@role='tabpanel'])[1]/descendant::table/tbody/tr[3]/td[2]/div")).click();
		Thread.sleep(5000);
		//Do logout
		driver.findElement(By.xpath(
